#ifndef __DLCV_PROC_IMPLEMENT_AVX_H__
#define __DLCV_PROC_IMPLEMENT_AVX_H__
...
void normalize_image_f1f1_implement_avx(const float*    src, 
                                        float*          dst, 
                                        int             width_aligned, 
                                        int             height, 
                                        int             src_line_element, 
...
void normalize_image_f3f3_implement_avx(const float*    src, 
                                        float*          dst, 
                                        int             width_aligned, 
                                        int             height, 
                                        int             src_line_element, 
...
void normalize_image_f4f4_implement_avx(const float*    src, 
                                        float*          dst, 
                                        int             width_aligned, 
                                        int             height, 
                                        int             src_line_element, 
