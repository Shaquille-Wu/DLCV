...
#define  VER_MAGIC(major, minor, tiny)   ((unsigned int)((((unsigned int)(major)) << 16) | (((unsigned int)(minor)) << 8) | ((unsigned int)(tiny))))
#define  VER_MAJOR(ver_magic)            ((((unsigned int)(ver_magic)) & 0x00FF0000U) >> 16)
#define  VER_MINOR(ver_magic)            ((((unsigned int)(ver_magic)) & 0x0000FF00U) >> 8)
#define  VER_TINY(ver_magic)             (((unsigned int)(ver_magic)) & 0x000000FFU)
/**
